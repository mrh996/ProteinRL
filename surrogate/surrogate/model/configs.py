...
# DIR
_C.DIR = CN()
_C.DIR.DATAFOLDER = './../../dataset/Largescale/'
_C.DIR.DATASET = './../../dataset/Largescale/largescale.txt'
_C.DIR.GRAPH = './../../dataset/Largescale/'
_C.DIR.OUTPUT_DIR = "./../../dataset/Largescale/results"
